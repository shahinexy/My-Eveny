  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl">
        ...
        {/* Report Card */}
        <div className="bg-card border rounded-lg p-6 mb-6 bg-white text-black">
          {/* User Info */}
          ...
          <div className="space-y-4 mb-6">
            <div className="flex gap-4">
              ...
              <span className="">Rude behavior</span>
            </div>
            <div className="flex gap-4">
              <span className="font-semibold min-w-fit">
                Venue:
              </span>
              <span className="">National Music Fest</span>
            </div>
            <div className="flex gap-4">
              <span className="font-semibold min-w-fit">
                Description:
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-card border border-border rounded-lg shadow-lg p-4 z-10">
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 hover:bg-muted rounded-lg transition-colors text-left"
                    >
                      <span className="">Permanent Block</span>
